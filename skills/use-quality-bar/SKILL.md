...
5. **Adjudicate a waiver.** Only advisory Findings are eligible. When step 4 identifies exceptional circumstances, submit the rationale, poll the Waiver Adjudication until terminal, and read every Waiver Decision. Done when every request has a terminal Decision.
