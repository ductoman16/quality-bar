...
/** @param {any} core @param {string} adjudicationId */
function startAdjudication(core, adjudicationId) {
...
/**
 * @param {any} core
 * @param {{adjudicationId: string, key: string, rationale: string, requestId: string}} facts
 */
function submitRequest(core, { adjudicationId, key, rationale, requestId }) {
...
/**
 * @param {any} core
 * @param {{adjudicationId: string, decisionId: string, outcome: "accepted" | "denied" | "error", requestId: string}} facts
 */
function decide(core, { adjudicationId, decisionId, outcome, requestId }) {
  ...
  test(`a fresh Request is rejected after a ${outcome} Decision`, () => {
    ...
    try {
      ...
      decide(core, {
        ...
        outcome: /** @type {"accepted" | "error"} */ (outcome),
        requestId: "request-1",
      });
