...
export function paidCodexPass(overrides: Record<string, unknown> = {}) {
  return {
...
export function paidCodexFailure(overrides: Record<string, unknown> = {}) {
  return {
    ...paidCodexPass(),
    failure: {
...
export function privateGitHubPass(overrides: Record<string, unknown> = {}) {
  return {
    completedAt: "2023-11-14T22:13:20.123Z",
    failure: null,
    fixture: {
...
export function privateGitHubFailure(overrides: Record<string, unknown> = {}) {
  return {
    ...privateGitHubPass(),
    failure: {
