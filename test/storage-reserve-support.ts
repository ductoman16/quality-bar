import { createForgejoConnectionService as createForgejoService } from "../src/forgejo/forgejo-connection.ts";
import { createGitHubConnectionService as createGitHubService } from "../src/github/github-connection.ts";
import { createGitHubPollingRunner as createGitHubRunner } from "../src/github/github-polling-runner.ts";
...
export const availableStorageReserve = Object.freeze({
  ...
  typeof import("../src/storage-reserve.ts").createStorageReserveGate
...
export function githubPullRequest(number: number) {
  return {
...
export function createAvailableForgejoConnectionService(
  durableCore: Parameters<typeof createForgejoService>[0],
  options: Omit<
    Parameters<typeof createForgejoService>[1],
...
export function createAvailableGitHubConnectionService(
  durableCore: Parameters<typeof createGitHubService>[0],
  options: Omit<
    Parameters<typeof createGitHubService>[1],
    | "acquirePullRequestChangeset"
    | "admitAutomaticEvaluation"
    | "storageReserve"
  > &
...
export function createAvailableGitHubPollingRunner(
  durableCore: Parameters<typeof createGitHubRunner>[0],
  options: Omit<
    Parameters<typeof createGitHubRunner>[1],
    | "acquirePullRequestChangeset"
    | "admitAutomaticEvaluation"
    | "storageReserve"
  > &
...
export function seedDueGitHubPoll(core: any) {
  core.run(
