...
import { createGitHubPollingRunner } from "../src/github/github-polling-runner.ts";
import { createIoExecutionPool } from "../src/io-execution-pool.ts";
import { createStorageReservePollingCore } from "../src/storage-reserve-polling-core.ts";
import {
...
test("SQLite polling advances no observation while the runtime reserve is unavailable", async (context) => {
  ...
  let reserveChecksBeforeLoss: number | null = null;
