...
import { publishSignedResponse } from "../src/review/review-run-submission-response.ts";
import {
  isProcessAlive,
  parseSubmissionLock,
  publishFile,
...
function runtimePath(
  ...
  return join(channel.commandDirectory, "quality-bar-submit-runtime.ts");
}
...
async function submit(
  channel: Awaited<ReturnType<typeof openReviewRunSubmissionChannel>>,
  checkoutPath: string,
  arguments_: string[] = [".quality-bar-result.json"],
) {
