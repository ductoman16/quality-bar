export function systemDeliveryRow(overrides: Record<string, any> = {}) {
  return {
...
export function fakeGitHubDeliveryCore(row: any) {
  return {
    all(query: string) {
...
export function addWaiverFollowupFacts(core: any, base: string, head: string) {
  core.run(
