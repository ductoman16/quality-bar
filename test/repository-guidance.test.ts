...
import { APPLICABILITY_RULE_PROFILE } from "../src/applicability/applicability-rule.ts";
import { buildRepositoryGuidance } from "../src/repository/repository-guidance.ts";
