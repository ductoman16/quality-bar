...
import { evaluateApplicabilityRule } from "../src/applicability/applicability-evaluation.ts";
import { resolvePushedCommitSelectors } from "../src/repository/repository-git.ts";
import { createBareRepository } from "./repository-git-integration-support.ts";
