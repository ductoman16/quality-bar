...
import { verifyGitHubRepositoryRead } from "../src/github/github-git-verification.ts";
import { createGitHubPollingService } from "../src/github/github-polling.ts";
import { createGitHubCommitStatusPublisher } from "../src/github/github-commit-status-api.ts";
import {
...
test("real Git distinguishes transient GitHub failure from definitive access loss", async (context) => {
  ...
  const verifyGit: typeof verifyRepositoryRead = (url, credential, options) =>
