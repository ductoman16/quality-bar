...
export const APPLICATION_COVERAGE_TEST_PATHS = Object.freeze([
  ...
  "test/onboarding-token.test.js",
  "test/onboarding-http-integration.test.js",
  "test/onboarding-mcp-integration.test.js",
  ...
  "test/review-catalog-browser-component.test.js",
