...
import { runReleaseCanary } from "./evidence.mts";
import { readPrivateGitHubCanaryConfiguration } from "./private-github-configuration.mts";
import { invokePrivateGitHubCanary } from "./private-github.mts";
...
function git(...arguments_: Array<string>) {
