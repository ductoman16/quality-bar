export const FAKE_CODEX_GATE_DEFINITION = {
  ...
  testGroup:
    "waiver-adjudication-configuration-and-exact-secret-excluding-file-change-kind-sides-invalid-correction-first-valid-four-meaning-criterion-result-process-termination-review-run-fake-codex-boundary",
