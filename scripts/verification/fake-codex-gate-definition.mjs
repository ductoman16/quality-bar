export const FAKE_CODEX_GATE_DEFINITION = {
  ...
  testGroup:
    "waiver-adjudication-configuration-and-exact-secret-excluding-file-change-kind-sides-invalid-correction-first-valid-four-meaning-criterion-result-multiple-independent-review-run-aggregation-raw-transcript-cli-timing-terminal-counter-process-termination-review-run-fake-codex-boundary",
