export const WAIVER_ADJUDICATION_GATE_DEFINITIONS = [
  {
    ...
    testGroup:
      "focused-exact-request-finding-criterion-review-version-evaluation-changeset-schema-and-inspection-prompt-plus-complete-decision-set-validation",
  ...
  },
  {
    ...
    testGroup:
      "queued-focused-waiver-adjudication-and-exact-owning-failure-browser-boundary",
  ...
  },
  {
    ...
    testGroup:
      "focused-claim-v38-migration-first-valid-atomic-complete-immutable-decision-set-and-raw-partial-rejection",
