import { GitHubConnectionError } from "../github/github-connection-error.ts";
import { forgejoDefinitiveFailureScope } from "../forgejo/forgejo-failure.ts";
import { fail as failRepository } from "./repository-validation.ts";
