...
import { APPLICABILITY_RULE_PROFILE } from "../applicability/applicability-rule.js";
import { readReviewCollection } from "../review/review-read-collection.js";
import { fail } from "../review/review-validation.js";
...
/** @param {any} review */
function guidanceReview(review) {
  ...
  return {
    ...
    applicability,
    assignment,
    criteria: activeVersion.criteria.map(
      /** @param {any} criterion */ (criterion) => ({
 ...
 * @param {any[]} reviews
 */
export function buildRepositoryGuidance(repository, reviews) {
 ...
 * @param {{
 *   transaction<Result>(
 *     callback: (transaction: import("../review/review-read-collection.js").ReviewTransaction) => Result
 *   ): Result
 * }} durableCore
 */
