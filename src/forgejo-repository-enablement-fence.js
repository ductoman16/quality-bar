...
export function requireCurrentForgejoConnection(transaction, connection) {
...
/** @param {any} transaction @param {string} connectionId @param {any[]} repositories */
...
/** @param {any} transaction @param {string} connectionId @param {number} expectedGeneration */
...
import { readForgejoPollingGeneration } from "./forgejo-polling.js";
