import { FORGEJO_POLL_INTERVAL_MS } from "./forgejo-polling.js";

/** @param {{all: Function}} durableCore @param {() => number} timestamp */
export function nextForgejoPollingDelay(durableCore, timestamp) {
