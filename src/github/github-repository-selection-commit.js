...
/** @param {any} transaction @param {any} connection @param {string} connectionId */
...
/** @param {any} transaction @param {string} connectionId @param {Map<number, any>} existing @param {number[]} repositoryIds */
...
/** @param {any} input */
export function createGitHubRepositorySelectionCommit(input) {
  const {
