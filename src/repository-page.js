...
const DETAIL_STYLE =
  ...
  ".repo-detail__actions button{min-height:32px;padding:5px 14px;border-radius:var(--qb-radius);font-size:12px}" +
  ...
  ".repo-guidance-raw #repository-detail-guidance-raw{max-height:280px;overflow:auto;margin:12px 0 0;padding:12px 14px;border:1px solid var(--qb-line);border-radius:var(--qb-radius);font-size:12px;line-height:1.5}";
...
const BASE_STYLE =
  ...
  ".repo-row__action{min-height:30px;padding:4px 13px;border-radius:var(--qb-radius);font-size:12px}" +
...
const ADD_STYLE =
  ...
  ".repo-add>summary{display:inline-flex;align-items:center;gap:5px;min-height:32px;padding:4px 12px;border-radius:var(--qb-radius);background:var(--qb-ink);color:var(--qb-canvas);font-size:12px;font-weight:650;list-style:none;cursor:pointer}" +
  ...
  ".repo-add__chooser{display:inline-flex;margin:18px 0 0;border:1px solid var(--qb-line);border-radius:var(--qb-radius);overflow:hidden}" +
