...
/** @param {any} envelope @param {string} token */
function hasValidRequestSignature(envelope, token) {
 ...
 *   state: {accepted: boolean, committed: boolean, lastValidationFailure: any, pendingResponse: any, processing: boolean, stopped: boolean},
...
export function createSubmissionProcessor(input) {
  /** @param {any} lockSubmission */
  function shouldDiscardLease(lockSubmission) {
