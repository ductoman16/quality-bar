import { readSystemDeliveryRows } from "./system-delivery-selection.js";
import { validateSystemDeliveryTargets } from "./system-delivery-target-validation.js";
import {
...
/** @param {any} row @param {"github" | "forgejo"} provider @param {number} now @returns {any} */
function deliverySurface(row, provider, now) {
  if (
  ...
  const gateNextAt = activeGate ? /** @type {number} */ (gate.until) : 0;
