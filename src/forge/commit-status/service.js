...
import { readEffectiveWaiverOutcome } from "../../waiver/waiver-followup-outcome.js";
import { COMMIT_STATUS_CONTEXT, commitStatusForEvaluation } from "./status.js";
 ...
 *   attemptDelivery: (durableCore: any, context: {
 *     row: any,
 *     status: {description: string, state: string},
 *     statusTarget: {description: string, head: string, state: string, targetUrl: string},
 *     target: string,
 *     now: () => number,
 *   }) => Promise<unknown>,
 * }} dependencies
