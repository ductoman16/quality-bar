import { readTerminalTokenCounters } from "../review/review-run-evidence.ts";

function assertClaim(claim: any) {
  if (
...
function assertAuthoritative(transaction: any, claim: any) {
...
export function createWaiverAdjudicationEvidenceService(durableCore: any) {
  return {
...
export function readWaiverAdjudicationTokenCounters(stdout: string) {
