...
const CONNECTION_RETIRED = (provider: "forgejo" | "github") => `EXISTS (
...
const PUBLICATION_UNAVAILABLE = (provider: "forgejo" | "github") =>
  provider === "forgejo"
    ? `(${CONNECTION_RETIRED(provider)} OR ${FORGEJO_REPOSITORY_RETIRED})`
    : CONNECTION_RETIRED(provider);

const UNAVAILABLE_CODE = (provider: "forgejo" | "github") => `CASE
...
const UNAVAILABLE_DETAIL = (provider: "forgejo" | "github") => `CASE
...
const STATUS_ON_START = (provider: "forgejo" | "github") => `
...
const STATUS_ON_FINISH = (provider: "forgejo" | "github") => `
  UPDATE ${provider}_commit_statuses
...
const FOLLOWUP_TABLES = (provider: "forgejo" | "github") => `
