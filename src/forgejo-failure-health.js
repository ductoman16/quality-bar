/** @param {any} transaction @param {string} connectionId @param {"connection" | "repository" | null} scope @param {number} verifiedAt */
...
/** @param {any} transaction @param {{completedVerification: any, connectionId: string, error: Error & {code: string, repositoryId?: number, repositoryIds?: number[]}, failedVerification: any, repositoryIds: number[], scope: "connection" | "repository" | null, verificationId: string, verifiedAt: number}} input */
export function commitForgejoReactivationFailure(transaction, input) {
...
function reactivationConflict(message) {
