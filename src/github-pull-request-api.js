...
/** @param {unknown} value @param {number} currentPage */
function nextPage(value, currentPage) {
  if (value === null) {
    return null;
  }
 ...
 * }} dependencies
 */
export function createGitHubPullRequestReader({ installationToken, request }) {
  /** @param {any} credential @param {number} installationId @param {{id?: unknown, full_name?: unknown}} repository */
