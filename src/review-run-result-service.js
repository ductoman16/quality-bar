  ...
  const service = {
    ...
    prepare(claim, candidate, fileChanges) {
      ...
      return durableCore.transaction((/** @type {any} */ transaction) => {
        const run = readAuthoritativeRun(transaction, claim, observedAt);
    ...
    /** @param {any} claim @param {any} submission */
    submitPrepared(claim, submission) {
      ...
      if (
        ...
        throw new TypeError("Prepared Review Run submission is invalid");
      }
      return durableCore.transaction((/** @type {any} */ transaction) => {
