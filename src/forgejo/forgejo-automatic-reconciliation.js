...
import { acquireForgejoAutomaticEvaluations } from "./forgejo-automatic-evaluation-admission.js";
...
/**
 * @param {{pollingCore: any, polling: any, row: any, prepared: any, generation: number, acquirePullRequestChangeset: (input: {pullRequest: any, repositoryId: string}) => Promise<any>, admitAutomaticEvaluation: (transaction: any, input: any) => unknown}} input
 */
