...
} from "./forgejo-delivery-target.ts";
...
function materializeForgejoFindingFeedback(
  durableCore: any,
  bundle: any,
  findings: any[],
) {
...
function validateForgejoFeedbackVerifier(verifier: any) {
  if (
...
function createForgejoAuthentication(cipher: any, bundle: any) {
  return () => ({
    base_url: bundle.base_url as string,
...
function attemptForgejoAggregateDelivery({
  ...
  return attemptForgejoDelivery(durableCore, {
    ...
    repositoryId: bundle.repository_id as string,
