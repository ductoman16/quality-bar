...
export type ReviewReadTransaction = {
  get(
    sql: string,
...
function readVersion(
  transaction: ReviewReadTransaction,
  version: Record<string, import("node:sqlite").SQLInputValue>,
) {
  if (
...
export function readReview(
  ...
  if (review.scope === "installation_wide") {
    ...
    assignment = {
      repository_ids: repositoryIds as string[],
