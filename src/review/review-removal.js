import { fail, validateDeletionRequest } from "./review-validation.js";
...
/**
 * @param {ReviewRemovalCore} durableCore
 * @param {string} reviewId
 * @param {unknown} request
 */
export function removeNeverUsedReview(durableCore, reviewId, request) {
